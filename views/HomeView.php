        ...
        <div class="home-blog">
          ...
          <div class="row">
            <div class="owl-home-blog owl-home-blog-bottompage"> 
              ...
              <!-- new item -->
              <div class="item">
                <div class="article"> <a href="#" class="image"> <img src="assets/upload/news/<?php echo $rows->photo; ?>" alt="<?php echo $rows->name; ?>" title="<?php echo $rows->name; ?>" class="img-responsive" style="width: 100%;"> </a>
                  <div class="info">
