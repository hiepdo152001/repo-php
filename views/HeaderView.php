...
<div class="container">
  <div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 header-search"> 
      ...
      <!-- autocomplete="off" trinh duyet khong goi nho keyword da nhap -->
      <!--</form>--> 
      <div class="smart-search">
        <ul>
          <!-- <li><img src="http://localhost/devpro/php60/php60_project/assets/upload/products/1653829943_132195019983557925_6.jpg"><a href="#">Sản phẩm</a></li>
          <li><img src="http://localhost/devpro/php60/php60_project/assets/upload/products/1653829943_132195019983557925_6.jpg"><a href="#">Sản phẩm</a></li>
          <li><img src="http://localhost/devpro/php60/php60_project/assets/upload/products/1653829943_132195019983557925_6.jpg"><a href="#">Sản phẩm</a></li> -->
        </ul>
      </div>
    ...
    <script type="text/javascript">
      function searchForm(event){
        //khi an phim enter thi nhay den trang tim kiem theo ten (phim enter co keyCode = 13)
        if(event.keyCode == 13){
